...
<head>
    ...
    <style>
        .menu-toggle {
            ...
            border: none;
            padding: 5px; /* menambahkan padding untuk membuat tombol lebih besar */
            cursor: pointer;
            display: flex;
        ...
        .burger-bar {
            ...
            margin: 4px auto; /* Mengatur jarak antara garis */
            transition: all 0.3s ease; /* Animasi saat diubah */
        }

        .menu-toggle.active .burger-bar:nth-child(1) {
            transform: rotate(45deg) translate(5px, 5px); /* Mengatur rotasi dan translasi untuk garis 1 */
        }

        .menu-toggle.active .burger-bar:nth-child(2) {
            opacity: 0; /* Menyembunyikan garis 2 */
        }

        .menu-toggle.active .burger-bar:nth-child(3) {
            transform: rotate(-45deg) translate(5px, -5px); /* Mengatur rotasi dan translasi untuk garis 3 */
        }
        ...
        @media only screen and (max-width: 600px) {
            .main-navbar {
                display: none; /* menyembunyikan navbar pada tampilan seluler */
            }

            .menu-toggle {
                display: block; /* menampilkan toggle menu pada tampilan seluler */
                position: absolute;
                top: 0;
                right: 0;
            }
            ...
            .menu-item {
                display: block; /* menampilkan setiap item menu dalam tampilan seluler */
            }

            .user-dropdown-name,
            .user-dropdown-status,
            .avatar {
                display: none; /* menyembunyikan avatar, nama, dan status pada tampilan seluler */
            }
        ...
        @media only screen and (min-width: 601px) {
            .menu-toggle {
                display: none; /* menyembunyikan toggle menu pada tampilan laptop */
            }

            .main-navbar {
                display: block; /* menampilkan navbar pada tampilan laptop */
            }
                ...
                <div class="header-top">
                    <div class="container">
                        ...
                        <div class="user-dropdown d-flex align-items-center dropend "
                            ...
                            <!-- Menyertakan tombol menu hanya pada tampilan seluler -->
                            ...
                            </div>                            <div class="user-dropdown-text">
