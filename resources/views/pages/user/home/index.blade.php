<x-user-layout title="Warabiz-Home" active="home">
    ...
    height: 100%;
    object-fit: cover;
    transition: opacity 1s ease-in-out; /* Menambahkan efek transisi smooth */
    opacity: 0; /* Sembunyikan semua gambar awalnya */
}

.banner-slide.active {
    opacity: 1; /* Tampilkan gambar yang sedang aktif */
}
...
.two-column-flexbox .card-column {
    flex: 1; /* Setiap kolom akan mengisi ruang yang sama */
    margin-right: 10px; /* Jarak antara kolom */
}
...
.category-item img {
    width: 100px; /* Sesuaikan ukuran gambar mini sesuai kebutuhan */
    height: auto;
    display: block;
}
...
.search-column .search-box:focus {
    ...
    <div class="banner-container">
        <img src="https://api.rintisan.co.id/storage/banners/zmipoQaqG8Z8MNlucvmNmRmlNus1ibAk9acjJiaa.png" alt="Banner 1" class="banner-slide">
        <img src="https://api.rintisan.co.id/storage/banners/ymejKHBvg5A8KG4eQqKDxjRHAb9SQwzHrg9xrehY.jpg" alt="Banner 2" class="banner-slide">
    </div>
        ...
        <div class="two-column-flexbox">
            <div class="card-column" style="padding-right: 40px;">
                ...
                <div id="carouselKategori" class="carousel slide">
                                ...
                                <div class="container">
                                    <div class="row">
                                        @foreach ($chunk as $category)
                                            <div class="col">
                                            <div class="category-item" style="width: 100%; height: 100%; border: 1px solid #ccc; border-radius: 5px; overflow: hidden;">
                                                <img src="{{ $category }}" alt="Kategori" style="width: 100%; height: 100%; object-fit: cover;">
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselKategori" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselKategori" data-bs-slide="next">
            ...
            <div class="card-column">
                <!-- Hapus judul "Cari Waralaba Keinginanmu" di perangkat seluler -->
                ...
                <div class="form-group mt-3">
                    <div class="input-group">
                        <input type="text" name="search" id="search" class="form-control border rounded-3 shadow-none" placeholder="Cari di warabiz">
                        <div class="input-group-append" style="margin-left: 15px;">
                            <button class="btn btn-primary" type="button" style="background-color: #009BB8; border: none; height: 40px;">
...
<style>
    ...
    @media only screen and (max-width: 576px) {
        ...
        .small-circle-img {
                display: none; /* Sembunyikan gambar kecil di perangkat seluler */
            }
...
<div class="container">
    ...
    <div id="carouselWaralaba" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="card card-populer">
                                    <div class="d-flex gap-3 align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h6 class="waralaba-name"><b>{{ substr($waralaba->waralaba_name, 0, 18) }}</b></h6>
                                            <p>{{ $waralaba->concept }} <span class="sold-count">{{ $waralaba->soldCount() }} Terjual</span></p>
                                        </div>
                                    </div>
                                </div>
                            </a>
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#carouselWaralaba" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#carouselWaralaba" data-bs-slide="next">
            <span class="carousel-control-next-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Next</span>
        </button>
    </div>
                    ...
                    <a href="{{ route('waralaba', $waralaba->id) }}" class="text-decoration-none">
                        <div class="card card-home">
                            ...
                            <div class="d-flex gap-3 align-items-center">
                                <img class="small-circle-img" src="{{ $waralaba->logo }}" alt="Waralaba Image">
                                <div class="d-flex flex-column">
                                    <h6 class="waralaba-name"><b>{{ substr($waralaba->waralaba_name, 0, 19) }}</b></h6>
