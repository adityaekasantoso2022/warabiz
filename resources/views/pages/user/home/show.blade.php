<x-user-layout title="{{ $home->title }}" active="home-show">
    @push('addonStyle')
        <style>
                ...
                <div class="col-md-6 mt-5 mt-lg-0">
                    <div class="d-flex float-lg-end align-items-center mt-sm-5 mt-md-0 mt-lg-0">
                        <div class="img-mentor me-3"
                            style="background-image: url('{{ asset('storage/' . $home->mentor->profile_picture) }}');">
                        </div>


                        <h6 class="text-mentor m-0">Mentor<br><span
                                class="text-secondary text-sm">{{ $home->mentor->full_name }}
                            </span></h6>
                    </div>
                </div>
            </div>
                        ...
                        <div class="d-flex">
                            <h6 class="text-mentor m-0">Rating<br>
                                ...
                                <span class="text-waring text-sm">
                                    <i class="fas fa-star text-warning me-2"></i>{{ $home->rating }} </span>
                            </h6>
                        </div>
                        <hr>
            ...
            <main class="col col-xl-8 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
                <div class="embed-responsive embed-responsive-16by9 video-iframe ">
                    <div class="plyr__video-embed" id="player">
                        <iframe src="{{ $home->trailer_url }}" allowfullscreen="" allowtransparency=""
                    ...
                    <div class="tab-pane fade show" id="pills-location" role="tabpanel"
                        ...
                        @if ($home->system == 'Offline')
                            ...
                            <div class="map p-4 mt-3">
                                ...
                                <div class="ratio mt-3" style="height: 280px">
                                    <iframe src="{{ $home->map_location }}" class="border-0 rounded-12"
                        ...
                        @else
                            <div class="col-12 text-center">
                                <strong>waralaba Ini Online</strong>
                            </div>
                        @endif
                    </div>
            ...
            <aside class="col col-xl-4 order-xl-3 col-lg-6 order-lg-3 col-md-6 col-sm-12 col-12">
                <div class="card card-info border-0 mt-sm-5 mt-lg-0 ">
                    <div class="card-body p-4 ">
                        ...
                        <div class="card-info-detail mt-4">
                            <div class="d-flex align-items-center justify-content-center gap-5">
                                <div class="d-flex text-center">
                                    <h2 class="text-info  m-0">{{ $home->meeting }}<br>
                                ...
                                <div class="d-flex text-center">
                                    <h2 class="text-info  m-0">{{ $home->per_week }}x<br>
                        ...
                        <p class="caption mt-4 text-center">{{ $home->home_info }}</p>
                        @auth
                            @if ($ht != null)
                                <a href="/home-playing/{{ $home->slug }}" class="btn btn-primary mt-5 w-100 ">
                                    Lanjutkan home
                                </a>
                            @else
                                <a href="/checkout/{{ $home->slug }}" class="btn btn-primary mt-5 w-100 ">
                                    Join home
                                </a>
                            @endif
                        @else
