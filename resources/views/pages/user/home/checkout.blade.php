<x-user-layout title="Checkout {{ $home->title }}" active="checkout">
    @push('addonStyle')
        <style>
            body {
                        ...
                        <div class="course-card">
                            <div class="embed-responsive embed-responsive-16by9 video-iframe ">
                                <div class="plyr__video-embed" id="player">
                                    <iframe
                                        src="{{ $home->trailer_url }}?autoplay=1&amp;?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1"
                    ...
                    <form id="form-manual" method="post" action="{{ route('checkout.checkout') }}">
                        ...
                        <div class="payment-details  mt-4">
                            <div class="item-pricing item-mentor">
                                ...
                                <input id="home_id" type="hidden" name="home_id" value="{{ $home->id }}">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="item">
                                        ...
                                        <input id="transaction_total" hidden="" name="transaction_total"
                                            value="{{ $home->price + $unique_code + 5000 }}">
                                        <p class="value">
                                            <strong id="midtransPrice">
                                                @idr($home->price - $unique_code + 5000)
                                            </strong>
                                        </p>
                                        <div class="clear"></div>
                                    </div>
                                    ...
                                    <select class="form-select" name="type">
                                        ...
                                        <option value="pay_later">Bayar Setelah Selesai home</option>
