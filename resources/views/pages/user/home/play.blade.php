<x-dashboard-user-layout title="{{ $home->title }}" active="play-class">
    @push('addonStyle')
        <style>
            body {
    ...
    @if ($home->system == 'Online')
        <div class="embed-responsive embed-responsive-16by9 video-iframe ">
            <div class="plyr__video-embed" id="player">
                <iframe
                    src="{{ $home->youtube_url }}?autoplay=1&amp;?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1"
    ...
    @if ($home->system == 'Offline')
        <img src="{{ asset('storage/' . $home->thumbnail) }}" alt="" class="img-thubmnail">

        <div class="card card-progress  mt-3">
            <div class="card-body">
                <div class="d-flex justify-content-between ">
                    <p class="card-text"><small class="text-muted">{{ $home->meeting }}x
                            Pertemuan</small></p>
                    <p class="card-text">
                        1x Pertemuan Lagi
                    </p>
