                        ...
                        <div class="course-card">
                            <div class="embed-responsive embed-responsive-16by9 video-iframe ">
                                <div class="plyr__video-embed" id="player">
                                    <iframe src="{{ $transaction->home->trailer_url }}" allowfullscreen=""
                            ...
                            <div class="course-detail">
                                <a>
                                    <h2 class="course-name line-clamp-2">
                                        {{ $transaction->home->title }}
                                    </h2>
                                </a>
                                <div class="d-flex mt-2 align-items-center gap-1">
                                    @idr($transaction->home->price)
                                </div>
                            </div>
                            ...
                            <div class="payment-details ">
                                <div class="item-pricing item-mentor">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <input id="transaction_home_id" hidden=""
                                            name="transaction_home_id" value="{{ $transaction->id }}">
                                        <div class="item">
                                            <p class="title">
                                                Total transfer
                                            </p>
                                        ...
                                        <a href="" class="mt-2 mb-2 btn btn-outline-dark  w-100  border-12 py-3">
                                            Bayar Nanti
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="item-pricing item-mentor">
                                    ...
                                    <div
                                        ...
                                        <p class="fw-bold"> <strong>
                                                Pembayaran akan ditagih setelah selesai home, dengan tempo 3 bulan
                                            </strong>
                                        </p>
                                    </div>
