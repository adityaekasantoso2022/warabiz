<x-user-layout title="Warabiz-Warapartner" active="warapartner">
    ...
    <section class="py-3" style="background-image: url('{{ asset('assets/frontend/image/bg/bg-warapartner.svg') }}'); background-size: 100% auto; background-position: center; background-repeat: no-repeat;">
        @if (optional($verifiedOwner)->status === 2)
            <!-- Show status message when the form is in process -->
            <div class="alert alert-info">
                Your submission is in process. Please wait for approval.
            </div>
        @elseif (optional($verifiedOwner)->status === 1)
            <!-- Show rejection message when the form is rejected -->
            <div class="alert alert-danger">
                Your submission has been rejected. Please review and update your information.
            </div>
        @else
            <!-- Show the form when the status is not in process or rejected -->
