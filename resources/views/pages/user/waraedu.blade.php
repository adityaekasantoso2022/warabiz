                    ...
                    <div id="banner-carousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="https://images.tokopedia.net/img/cache/1208/NsjrJu/2024/2/15/2fdc3b2e-c9de-4d7c-b338-5aa544231639.jpg.webp?ect=4g" class="d-block w-100" alt="Banner 1">
                            </div>
                            <div class="carousel-item">
                                <img src="https://images.tokopedia.net/img/cache/1208/NsjrJu/2024/2/15/9e0cbddf-0b29-4fe9-810a-9fdcc140271f.jpg.webp?ect=4g" class="d-block w-100" alt="Banner 2">
                            </div>
                            <div class="carousel-item">
                                <img src="https://images.tokopedia.net/img/cache/1208/NsjrJu/2024/2/22/b9519e4c-81c6-4791-acc7-c192c5f524c9.jpg.webp?ect=4g" class="d-block w-100" alt="Banner 3">
                            </div>
                        </div>
                        ...
                        <div class="article-card zoom-effect">
                            <a href="{{ route('waraedu-detail', $article->id) }}" class="text-decoration-none">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>{{ $article->category }} <span class="sold-count">{{ \Carbon\Carbon::parse($article->created_at)->format('d/m/Y H:i') }}</span></p>
