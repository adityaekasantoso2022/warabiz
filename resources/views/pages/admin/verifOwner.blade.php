<x-admin-layout title="Verifikasi Owner" active="verifowner" style="margin-top: 0;">
                    ...
                    <div class="verifOwner-list">
                        ...
                        <table class="verifOwner-table">
                            ...
                            <tbody>
                                ...
                                <tr class="verifOwner-row"
                                    data-status="{{ $verifOwner->status }}">
    ...
    <script>
        document.getElementById("searchInput").addEventListener("input", function () {
            ...
            table = document.querySelector(".verifOwner-table");
        ...
        document.getElementById("statusFilter").addEventListener("change", function () {
            ...
            for (i = 0; i < tr.length; i++) {
                tdStatus = tr[i].getElementsByTagName("td")[16]; // Kolom untuk status transaksi
                if (tdStatus) {
