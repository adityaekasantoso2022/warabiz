<x-owner-layout title="Edit Waralaba" active="waralaba" style="margin-top: 0;">
    @push('addonStyle')
    <style>
        body {
    ...
    <section>
        <div class="container">
            <div class="waralaba-card">
                <h3>Edit Waralaba</h3>
                <form method="POST" action="{{ route('owner.waralaba.update', $waralaba->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
