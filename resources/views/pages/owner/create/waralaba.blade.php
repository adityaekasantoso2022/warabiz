                ...
                <form method="POST" action="{{ route('owner.waralaba.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="description" class="form-label required">Deskripsi Waralaba</label>
                                <textarea class="form-control" id="description" name="description"
                                    style="height: 125px;"
                                    placeholder="Deskripsi Waralaba">{{ old('description') }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label for="price" class="form-label required">Harga Waralaba</label>
                            ...
                            <div class="mb-3">
                                <label for="concept" class="form-label required">Konsep</label>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="outlet_total" class="form-label required">Total Outlet</label>
                                <input type="number" class="form-control" id="outlet_total" name="outlet_total"
                                    placeholder="Total Outlet" required>
                            </div>
                            <div class="mb-3">
                                <label for="license_duration" class="form-label required">Durasi Lisensi (Tahun)</label>
                            ...
                            <div class="mb-3" style="display: none;">
                                <label for="rating" class="form-label required">Rating Waralaba</label>
                                <input type="number" class="form-control" id="rating" name="rating" value="0" hidden>
                            </div>
                            <div class="mb-3">
                                <label for="image_url_1" class="form-label required">Gambar 1</label>
                                <input type="file" class="form-control" id="image_url_1" name="image_url_1"
                                    accept="image/*" placeholder="Pilih Gambar" required>
                            </div>
                            <div class="mb-3">
                                <label for="image_url_2" class="form-label required">Gambar 2</label>
                                <input type="file" class="form-control" id="image_url_2" name="image_url_2"
                                    accept="image/*" placeholder="Pilih Gambar" required>
                            </div>
                            <div class="mb-3">
                                <label for="image_url_3" class="form-label required">Gambar 3</label>
                                <input type="file" class="form-control" id="image_url_3" name="image_url_3"
                                    accept="image/*" placeholder="Pilih Gambar" required>
                            </div>
                            <div class="mb-3">
                                <label for="image_url_4" class="form-label required">Gambar 4</label>
                                <input type="file" class="form-control" id="image_url_4" name="image_url_4"
                                    accept="image/*" placeholder="Pilih Gambar" required>
                            </div>
                            <div class="mb-3">
                                <label for="image_url_5" class="form-label required">Gambar 5</label>
