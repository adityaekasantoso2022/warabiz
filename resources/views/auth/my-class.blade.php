<x-dashboard-user-layout title="Kelas Saya" active="my-class">
        ...
        <div class="row ">
            @foreach ($ut as $ut)
                <div class="col col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="card card-home shadow-sm mt-4">
                        <a href="/home-playing/{{ $ut->home->slug }}" class="m-2 mb-1 border-0 position-relative">
                            <div class="card-img-top"
                                style="background-image: url('{{ asset('storage/' . $ut->home->thumbnail) }}');">
                            </div>
                        </a>
                        <a href="" class="card-body">
                            <h5 class="card-title">{{ $ut->home->title }}</h5>
                            <p>System: @if ($ut->home->system == 'Offline')
                                    <span class="off">Offline</span>
                                @endif
                                @if ($ut->home->system == 'Online')
    ...
    @else
        <div class="col-12 text-center p-5 text-danger">
            <strong>Anda Belum Memiliki home</strong>
        </div>
    @endif
