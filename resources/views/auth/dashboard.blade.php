            ...
            <div class="card card-home mt-4 border-0 ">
                <div class="row g-0">
                    <div class="col-md-4 p-2">
                        <img src="{{ asset('storage/' . $ut->home->thumbnail) }}" class="img-fluid  rounded-3"
                            alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mt-5">
                                <p class="card-text"><small class="text-muted">{{ $ut->home->meeting }}x
                                        Pertemuan</small></p>
                                <p class="card-text">System: @if ($ut->home->system == 'Offline')
